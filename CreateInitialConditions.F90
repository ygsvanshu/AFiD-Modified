...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      do k=1,nxm
           ...
           yyy=xm(k) 
           xxx=yc(j)
           vy(k,j,i)=(1.0d0*yyy-1.0d0*yyy**2+1.0d0*yyy**3)*sin(3.14159*xxx)*eps
           vz(k,j,i)=(1.0d0*yyy-1.0d0*yyy**2+1.0d0*yyy**3)*cos(3.14159*xxx)*eps
           yyy=xc(k)
           xxx=ym(j)
           vx(k,j,i)=-yyy**2*(1.0d0-yyy)**2*cos(3.14159*xxx)*eps
         enddo
        enddo
      enddo
